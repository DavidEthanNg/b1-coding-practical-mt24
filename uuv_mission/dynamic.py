...
class ClosedLoop:
    ...
    def simulate(self,  mission: Mission, disturbances: np.ndarray) -> Trajectory:
        ...
        # Setting initial error for first time step
        previous_error = 0
        ...
        for t in range(T):
            ...
            current_error = Controller.error(self, reference_t, observation_t)
            actions[t] = Controller.control_action(self, current_error, previous_error)
